 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
// SERIAL_PORT_2 must be disabled with TFT_LVGL_UI* and MKS_WIFI_MODULE
...
#define INVERT_Z_DIR true  // TMC2209
...
#define INVERT_E0_DIR true  // TMC2209
...
#define TOUCH_SCREEN
  ...
  #define BUTTON_DELAY_MENU     350 // (ms) Button repeat delay for menus
